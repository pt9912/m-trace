...
//  für Tests und expliziten Dev-Fallback (ADR-0002).
//  - persistence/sqlite: SQLite-Datei, restart-stabil, Default ab
//  `0.4.0` im Compose-Lab (ADR-0002).
//
...
// auf State=Ended schaltet ( Sub-Item 8;
// telemetry-model.md). Wird vom UpsertFromEvents-Pfad jedes
// Adapters konsumiert.
