  ...
  "events": [
    {
      ...
      "sdk": { "name": "@npm9912/player-sdk", "version": "0.11.0" }
    }
  ]
}`
...
func newTestServerWithClock(t *testing.T, clock func() time.Time, opts ...testServerOption) *httptest.Server {
	...
	router := apihttp.NewRouter(uc, sessionsService, nil, resolver, resolver, publisher.Handler(), nil, nil, sseCfg, nil, nil, nil, nil, nil, logger)
