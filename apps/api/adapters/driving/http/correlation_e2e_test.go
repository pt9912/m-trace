...
func TestE2E_MixedEventTypes_ShareCorrelationID(t *testing.T) {
	...
	body := `{
	  "schema_version": "1.0",
	  "events": [
	    {"event_name":"playback_started","project_id":"demo","session_id":"sess-mix","client_timestamp":"2026-04-28T12:00:00.000Z","sequence_number":1,"sdk":{"name":"@npm9912/player-sdk","version":"0.8.5"}},
	    {"event_name":"manifest_loaded","project_id":"demo","session_id":"sess-mix","client_timestamp":"2026-04-28T12:00:00.100Z","sequence_number":2,"sdk":{"name":"@npm9912/player-sdk","version":"0.8.5"},"meta":{"network.kind":"manifest","network.detail_status":"available"}},
	    {"event_name":"segment_loaded","project_id":"demo","session_id":"sess-mix","client_timestamp":"2026-04-28T12:00:00.200Z","sequence_number":3,"sdk":{"name":"@npm9912/player-sdk","version":"0.8.5"},"meta":{"network.kind":"segment","network.detail_status":"available"}},
	    {"event_name":"rebuffer_started","project_id":"demo","session_id":"sess-mix","client_timestamp":"2026-04-28T12:00:00.300Z","sequence_number":4,"sdk":{"name":"@npm9912/player-sdk","version":"0.8.5"}},
	    {"event_name":"playback_error","project_id":"demo","session_id":"sess-mix","client_timestamp":"2026-04-28T12:00:00.400Z","sequence_number":5,"sdk":{"name":"@npm9912/player-sdk","version":"0.8.5"}}
	  ]
	}`
...
func TestE2E_CrossBatch_SameCorrelationID(t *testing.T) {
	...
	first := `{
	  "schema_version": "1.0",
	  "events": [{"event_name":"manifest_loaded","project_id":"demo","session_id":"sess-2bat","client_timestamp":"2026-04-28T12:00:00.000Z","sequence_number":1,"sdk":{"name":"@npm9912/player-sdk","version":"0.8.5"}}]
	}`
	second := `{
	  "schema_version": "1.0",
	  "events": [{"event_name":"segment_loaded","project_id":"demo","session_id":"sess-2bat","client_timestamp":"2026-04-28T12:00:01.000Z","sequence_number":2,"sdk":{"name":"@npm9912/player-sdk","version":"0.8.5"}}]
	}`
...
func TestE2E_Degradation_NetworkDetailUnavailable(t *testing.T) {
	...
	body := `{
	  "schema_version": "1.0",
	  "events": [
	    {"event_name":"manifest_loaded","project_id":"demo","session_id":"sess-deg","client_timestamp":"2026-04-28T12:00:00.000Z","sequence_number":1,"sdk":{"name":"@npm9912/player-sdk","version":"0.8.5"},"meta":{"network.kind":"manifest","network.detail_status":"network_detail_unavailable","network.unavailable_reason":"cors_timing_blocked"}}
	  ]
	}`
	if r := postEvents(t, srv, "demo-token", body); r.StatusCode != http.StatusAccepted {
		t.Fatalf("post: %d", r.StatusCode)
...
func TestE2E_Degradation_CapabilityOnlyBoundary(t *testing.T) {
	...
	body := `{
	  "schema_version": "1.0",
	  "events": [
	    {"event_name":"playback_started","project_id":"demo","session_id":"sess-cap","client_timestamp":"2026-04-28T12:00:00.000Z","sequence_number":1,"sdk":{"name":"@npm9912/player-sdk","version":"0.8.5"}}
	  ],
	  "session_boundaries": [
...
func TestE2E_TraceparentPropagation_SameTraceID(t *testing.T) {
	...
	body := `{
	  "schema_version": "1.0",
	  "events": [{"event_name":"manifest_loaded","project_id":"demo","session_id":"sess-tp","client_timestamp":"2026-04-28T12:00:00.000Z","sequence_number":1,"sdk":{"name":"@npm9912/player-sdk","version":"0.8.5"}}]
	}`
	for i := 0; i < 2; i++ {
