...
func FuzzWireBatchDecode(f *testing.F) {
	...
	f.Add([]byte(`{"schema_version":"1.0","events":[{"event_name":"playback_started","project_id":"demo","session_id":"01J","client_timestamp":"2026-04-28T12:00:00Z","sdk":{"name":"@npm9912/player-sdk","version":"0.10.0"}}]}`))
	f.Add([]byte(`{}`))
	f.Add([]byte(`null`))
