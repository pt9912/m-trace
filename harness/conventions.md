...
| [009](conventions/MR-009-adr-trigger-grandfathering.md) <a id="mr-009"></a> | ADR-Re-Evaluierungs-Trigger-Grandfathering | `docs/plan/adr/0001-*.md`–`0008-*.md` | `modul-04-adrs.md` §Kernidee (Modul 4) |
