...
> Status: `0.1.1` — Player-SDK + Dashboard, Lastenheft `1.1.6` verbindlich.
...
Das Projekt steht bei `0.1.1`: Lastenheft `1.1.6` verbindlich, Player-SDK und Dashboard sind auf `main` integriert.
