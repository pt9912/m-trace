...
> Status: Pre-MVP `0.1.0` — Backend-Skelett auf `main`, Lastenheft `1.0.2` verbindlich.
...
Das Projekt ist in der Pre-MVP-`0.1.0`-Phase: Backend-Spike abgeschlossen, Lastenheft `1.0.2` verbindlich, `apps/api`-Skelett auf `main` integriert.

Leitende Dokumente:

```text
docs/lastenheft.md           # Anforderungen (verbindlich, 1.0.2)
