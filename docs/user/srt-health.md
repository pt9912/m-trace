...
[`plan-0.6.0.md`](../plan/planning/done/plan-0.6.0.md) §0.1.
...
| Cursor-Pagination im History-Read-Pfad | spec §7a.3 dokumentiert das Wire-Format; SQLite-Adapter ist als ErrNotImplemented gestubbed (siehe [`plan-0.6.0.md`](../plan/planning/done/plan-0.6.0.md) §4 Sub-3.3). |
