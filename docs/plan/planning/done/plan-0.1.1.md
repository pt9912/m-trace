...
> **Bezug**: [Lastenheft `1.1.6`](../../../../spec/lastenheft.md) §13.2 (RAK-2, RAK-5, RAK-7), §18 (MVP-DoD-Anteil); [Roadmap](../in-progress/roadmap.md) §3; [Architektur (Zielbild)](../../../../spec/architecture.md); [API-Kontrakt](../../../../spec/backend-api-contract.md); [Risiken-Backlog](../risks-backlog.md).
