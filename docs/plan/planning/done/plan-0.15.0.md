...
| RAK-104 | `docs/planning/done/plan-0.15.0.md`, `spec/lastenheft.md` §8.3/§13.19, `docs/planning/done/plan-0.16.0.md` Szenario B | 2026-05-12 | Platform/QA | ✅ |
