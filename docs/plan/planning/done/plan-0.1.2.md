...
> **Bezug**: [Lastenheft `1.1.6`](../../../../spec/lastenheft.md) §13.3 (RAK-9, RAK-10), §18 (MVP-DoD-Anteil); [Roadmap](../in-progress/roadmap.md) §3; [Architektur (Zielbild)](../../../../spec/architecture.md); [API-Kontrakt](../../../../spec/backend-api-contract.md); [Risiken-Backlog](../risks-backlog.md).
