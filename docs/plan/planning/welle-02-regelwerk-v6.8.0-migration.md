...
| [`slice-022`](in-progress/slice-022-hermetic-fuzz-mutation-export.md) | Docker-Harness-Audit Teil 3: hermetische Gate-Stages für `apps/api` Fuzz/Mutation (Schreib-Rückweg-Export, root-Ownership-Risiko bei `mutation-report`) | Modul 14 |
