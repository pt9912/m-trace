...
> + W5 (Layout-Move, MR-001 aufgelöst) umgesetzt**; nächste Welle W6 (Kanonische
> Planning-Form + roadmap-Reformat). Umsetzung von
...
> aufgelöst, immutable-ADR-Verweise per `ignore-refs`-Tombstone) · W6–W7 offen.
