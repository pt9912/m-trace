...
- Build-Stages (Detailstruktur in `docs/planning/done/plan-spike.md` §14.11):
...
Pflichttests (Detailaufstellung in `docs/planning/done/plan-spike.md` §7.1):
...
| Größe des Dependency-Caches | isolierter Cache pro Prototyp (siehe Hinweis in `docs/planning/done/plan-spike.md` §7.2) |
