...
### 1.2 Nächste Phase `0.8.0`

`0.7.0` ist veröffentlicht; `0.8.0` (Player-SDK-WebRTC-Adapter)
ist die nächste geplante Phase. Sie löst RAK-51 (Lastenheft `1.1.9`
§13.9, „Kann") als produktive Lieferung ein und aktiviert den
WebRTC-Telemetrie-Pfad aus [`spec/telemetry-model.md`](../../../spec/telemetry-model.md)
§3.5. Plan-Skelett unter
[`plan-0.8.0.md`](../open/plan-0.8.0.md) (Status `⬜ geplant`, in
`open/`); ein begleitender Lastenheft-Patch `1.1.10` ist vorgesehen,
um RAK-51 verbindlich auf „Muss/Soll" zu heben und 2–3 neue RAK
für die Sub-Items (Public-API + hls.js-Trennung, produktive
WebRTC-Telemetrie, Compat-Tests) zu setzen — Details im Plan-Skelett
§0.2. Lieferübersicht der `0.5.0`-Tranchen (zur Historie, finaler
Stand siehe [`done/plan-0.5.0.md`](../done/plan-0.5.0.md)):
...
| 40  | ⬜      | Lastenheft-Patch `1.1.10` schreiben — RAK-51 von „Kann" auf „Muss/Soll" hochziehen + neue RAK-52..RAK-55 für Public-API/hls.js-Trennung, produktive WebRTC-Telemetrie und Compat-Tests definieren                | Vor Tranche-0-Aktivierung von `0.8.0`                            | RAK-51, MVP-24; [`plan-0.8.0.md`](../open/plan-0.8.0.md) §0.2                                                    |
| 41  | ⬜      | `0.8.0` Player-SDK-WebRTC-Adapter ausliefern: Public-API + hls.js-Trennung, WHEP-Adapter gegen `examples/webrtc/`, produktive WebRTC-Telemetrie auf `spec/telemetry-model.md` §3.2/§3.5-Allowlist (R-12 wird release-blockierend), Compat-Tests | Nach Schritt 40                                                  | RAK-51 (+ neue RAK aus 1.1.10); [`plan-0.8.0.md`](../open/plan-0.8.0.md) Tranchen 0–5                             |
...
| `0.8.0` | Player-SDK-WebRTC-Adapter    | ⬜      | RAK-51 (Lastenheft `1.1.9` §13.9) plus geplanter `1.1.10`-Patch (neue RAK-52..RAK-55 für Public-API/Telemetrie/Compat); Plan-Skelett in [`open/plan-0.8.0.md`](../open/plan-0.8.0.md) |
