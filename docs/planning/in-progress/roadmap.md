...
> Analyzer Boundary. Tranche 1 hat die Zielgruppe entschieden;
> Tranche 2 bewertet als nächstes die Analyzer-API-Boundary.
...
Folge-Scope. Der Plan importiert aus `0.14.0`: Postgres bleibt
