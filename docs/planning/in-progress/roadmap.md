...
| `0.18.0` | Offene Risiken / Trigger-Re-Eval | 🟡 | Restoffen-Closeout am 2026-05-13 in [`open/plan-0.18.0.md`](../open/plan-0.18.0.md): `R-9` bleibt K8s-Smoke-/Scrape-Policy-Trigger, `R-12` bleibt Nightly-detektierter WebRTC-Drift-Pfad ohne Safari-/WebKit-Pflicht, `R-13` bleibt Trivy-`continued` mit Re-Review-Artefakt und `expires` `2026-11-02`. Kein Release-/Versions-Closeout; letzter Release bleibt `0.17.0`. |
