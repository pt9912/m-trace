...
> **Stand**: 2026-05-10
>
> **Phase**: `0.12.1` aktivierbar — Trigger-Re-Eval + Operator-Doku
> (Patch nach `0.12.0`-Release; Plan in
> [`open/plan-0.12.1.md`](../open/plan-0.12.1.md)). Folge-Minor
> `0.12.5` für Auth-/Ingest-Adapter (R-17/R-18/R-20/R-21) in
...
`0.12.1` (Trigger-Re-Eval + Operator-Doku) ist die nächste
aktivierbare Phase als **Patch-Release** nach `0.12.0` — Plan in
[`open/plan-0.12.1.md`](../open/plan-0.12.1.md). Inhalt: Trigger-
...
| 47.5 | ⬜    | `0.12.1` Trigger-Re-Eval + Operator-Doku als Patch-Release ausliefern: pro aktivem `R-N`-Item im Backlog (R-5/R-7/R-9/R-10/R-11/R-12/R-13/R-14/R-15/R-16/R-17/R-18/R-20/R-21) Trigger-Status-Notiz, Operator-Runbook für Multi-Key-Rotation (Doku-Stand) in `auth.md` §5.3, Trigger-Schärfung der `OS-1`..`OS-6`-Folge-Items aus `done/plan-0.12.0.md` §10. Kein Lastenheft-Patch, keine RAK-Matrix, keine neue User-Surface. | Nach Schritt 47 | R-5..R-21; [`open/plan-0.12.1.md`](../open/plan-0.12.1.md) |
...
| `0.12.1` | Trigger-Re-Eval + Operator-Doku (Patch) | ⬜ | Plan in [`open/plan-0.12.1.md`](../open/plan-0.12.1.md), aktivierbar nach `0.12.0`. Patch-Release im Sinne von `releasing.md` §3.1 — keine neue User-Surface, kein Lastenheft-Patch, keine RAK-Matrix. Inhalt: Trigger-Re-Eval pro aktivem R-N-Item (R-5/R-7/R-9/R-10/R-11/R-12/R-13/R-14/R-15/R-16/R-17/R-18/R-20/R-21), Operator-Runbook für Multi-Key-Signing-Rotation (Doku-Stand; Code-Pfad in `0.12.5`), Trigger-Schärfung der `OS-1..OS-6`-Folge-Items aus `done/plan-0.12.0.md` §10. **Out of scope:** alle Adapter-Implementierungen — die wandern in `0.12.5`. |
