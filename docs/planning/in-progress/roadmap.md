...
`0.12.0` (Auth / Token Lifecycle) ist die nächste aktivierbare Phase
— Plan-Skizze in [`open/plan-0.12.0.md`](../open/plan-0.12.0.md),
Lastenheft-Patch noch offen. Vorgänger `0.11.0` ist released
(Plan archiviert in
