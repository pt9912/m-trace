...
| 40  | ⬜      | Lastenheft-Patch `1.1.10` schreiben — RAK-51 von „Kann" auf „Muss" hochziehen + neue RAK-52..RAK-55 für Public-API/hls.js-Trennung, produktive WebRTC-Telemetrie und Compat-Tests definieren                | Vor Tranche-0-Aktivierung von `0.8.0`                            | RAK-51, MVP-24; [`plan-0.8.0.md`](../open/plan-0.8.0.md) §0.2                                                    |
