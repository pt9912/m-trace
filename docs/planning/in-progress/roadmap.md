...
Fixture-Nachweisen. Tranche 3 schließt die zugehoerigen Gates ab:
`make ts-test`, `make ts-lint`, `make docs-check`,
`make generated-drift-check` und `make security-gates` sind gruen.
Externe Analyzer-API,
