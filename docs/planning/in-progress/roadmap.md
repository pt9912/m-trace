...
> Evidence Review. Tranche 0 importiert `0.16.0`, waehlt Szenario D
> (Hardening-only), vergibt Lastenheft-Patch `1.1.22` mit
> RAK-111..RAK-115 in §13.21 und laesst Productization, Next Slice,
> Switch, Analyzer-API, Control-Plane, Postgres/Analytics und
> Production-K8s bis zum Evidence Review deferred. Plan in
...
| 🟡      | Hardening / Evidence Review (`0.17.0`) | Aktiv seit 2026-05-13. Lastenheft-Patch `1.1.22` mit RAK-111..RAK-115 in §13.21. Szenario D: Hardening-only. Tranche 0 importiert das `0.16.0`-Closeout, haelt Productization/Next Slice/Switch deferred und startet Tranche 1 als Evidence Review des gelieferten HLS-Range-Fetch-Slice. | [`plan-0.17.0.md`](plan-0.17.0.md) |

### 1.2 Nächste Phase

`0.17.0` ist aktiv in
[`plan-0.17.0.md`](plan-0.17.0.md). Tranche 0 importiert das
`0.16.0`-Closeout und waehlt Szenario D: Hardening-only. Der Release
startet mit Evidence Review statt neuer Product-Surface; RAK-111 ist
geschlossen, RAK-112..RAK-115 bleiben fuer Evidence Review,
Hardening, Compatibility und Closeout offen. Productization, Next
Slice oder Switch bleiben blockiert, bis Tranche 1 einen konkreten
Konsumenten, eine Testluecke oder einen belastbaren Trigger nachweist.
...
| 52  | 🟡      | `0.17.0` Hardening / Evidence Review aktivieren: `0.16.0`-Closeout importieren, Szenario D waehlen, Lastenheft-Patch `1.1.22` mit RAK-111..RAK-115 vergeben und Productization/Next Slice/Switch bis zum Evidence Review deferred halten. | Nach Schritt 51 | RAK-111 ✅; `spec/lastenheft.md` §13.21; [`plan-0.17.0.md`](plan-0.17.0.md) |
...
| `0.17.0` | Hardening / Evidence Review | 🟡 | Aktiv seit 2026-05-13 in [`plan-0.17.0.md`](plan-0.17.0.md). Szenario D: Hardening-only. Tranche 0 erledigt RAK-111 mit Import des `0.16.0`-Closeouts, Lastenheft-Patch `1.1.22` und Defer-Matrix fuer Analyzer-API, Next Slice, Control-Plane, Postgres, Analytics und Production-K8s. Tranche 1 prueft Evidence und Scope fuer RAK-112. |
