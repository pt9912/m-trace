...
[`plan-0.7.0.md`](../open/plan-0.7.0.md). Lieferübersicht der `0.5.0`-
...
| SRT-Binding-Stack                                                 | obsolet                                    | ⬛ Nicht mehr nötig: `0.6.0` Tranche 1 wählt MediaMTX-/Server-API über HTTP als SRT-Metrikquelle (R-2 aufgelöst, CGO-frei). Wieder-Eröffnung nur, falls die HTTP-Quelle in einer Folge-Phase nicht mehr trägt und libsrt-Binding doch nötig wird.                                                                                                |
