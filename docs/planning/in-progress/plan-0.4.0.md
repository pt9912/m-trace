...
- [ ] F-40 (`Links zu Grafana, Prometheus und Media-Server-Konsole`) ist in Tranche 4 binär: entweder eine reine konfigurationsgetriebene Link-Section mit dokumentierten Config-Keys, Verhalten bei fehlenden URLs und Dashboard-Test wird umgesetzt, oder F-40 steht als explizites Deferred-/Nicht-Scope-Item mit Zieltranche Tranche 6/Observability im Plan. Es gibt keine stillschweigende F-40-Erfüllung ohne DoD-Test.
