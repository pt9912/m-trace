...
> **Status**: 🟡 in Arbeit. Tranche 0, Tranche 1 (§2.1–§2.6), Tranche 2 (§3.1–§3.4 inkl. §3.4c-Closeout), **Tranche 3 (§4.1–§4.7)** und **Tranche 4 (§5 H1–H6)** vollständig abgeschlossen; Roadmap Schritte 31, 32 und 33 sind auf ✅. Offen: Tranchen 5–8. Tranche 5 (optionales Tempo-Profil) ist der nächste Schritt; das Plan-DoD lässt explizit ein Deferred-Gate zu.
