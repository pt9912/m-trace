...
> **Status**: 🟡 in Arbeit. Tranche 0, Tranche 1 (§2.1–§2.6), Tranche 2 (§3.1–§3.4 inkl. §3.4c-Closeout), **Tranche 3 (§4.1–§4.7)**, **Tranche 4 (§5 H1–H6)**, **Tranche 5 (§6.1–§6.5)** und **Tranche 6 (§7.1–§7.4)** vollständig abgeschlossen; Roadmap Schritte 31, 32, 33 und 34 sind auf ✅, Schritt 35 (Tranchen 6 + 7) ist auf 🟡, Tranche 6 abgeschlossen. Offen: Tranchen 7–8. Tranche 7 (Cardinality- und Sampling-Dokumentation, RAK-35) ist der nächste Schritt.
