...
> **Stand**: 2026-05-06 (0.8.0 Tranche 3 — R-12 von „Triggerschwelle nicht ausgelöst" auf „release-blockierend ab nächstem Browser-Major-Bump" angehoben, weil produktive WebRTC-Telemetrie mit `mtrace_webrtc_*`-Countern ausgeliefert ist)  
