...
> [`plan-0.8.5.md`](./plan-0.8.5.md) Wave 1 (Security + Generated-
...
- **`0.9.0` ist released** (Tag `v0.9.0`). Der Drift-Smoke aus
  `plan-0.9.0.md` Tranche 1 ist live; SRS-Lab und DASH-Analyse
  sind ausgeliefert. `0.9.5` ist das Quality-Hardening-Patch
  **nach** dem Feature-Release.
