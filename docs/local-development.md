...
> **Bezug**: [Lastenheft `1.1.5`](./lastenheft.md) AK-1, AK-2, RAK-8, MVP-7; [Roadmap](./roadmap.md) §2 Schritt 7; [Plan `0.1.0`](./plan-0.1.0.md) §3.6 (Wartung) und §5.2 (Compose-Lab Core); [Architektur](./architecture.md) §8.
