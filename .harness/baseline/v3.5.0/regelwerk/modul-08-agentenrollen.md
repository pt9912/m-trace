...
<!-- Quelle: [03-agenten/modul-08-agentenrollen.md](https://github.com/pt9912/ai-harness-course/blob/v3.5.0/kurs/de/03-agenten/modul-08-agentenrollen.md) -->
...
- **Wann *nicht* modellieren:** bei isolierten LOW/INFO-Findings ist die
  ...
  **HIGH mit Rollen-Widerspruch** oder ab dem **dritten** gleichen
  ...
  [`reflexion-vorlage.md`](https://github.com/pt9912/ai-harness-course/blob/v3.5.0/kurs/de/grundlagen/reflexion-vorlage.md#wann-darf-eine-reflexion-nicht-zu-einer-harness-änderung-führen)).
